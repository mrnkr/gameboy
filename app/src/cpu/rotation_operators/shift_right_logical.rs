...
#[instruction(0x38, ArithmeticTarget::B, prefixed = true)]
#[instruction(0x39, ArithmeticTarget::C, prefixed = true)]
#[instruction(0x3A, ArithmeticTarget::D, prefixed = true)]
#[instruction(0x3B, ArithmeticTarget::E, prefixed = true)]
#[instruction(0x3C, ArithmeticTarget::H, prefixed = true)]
#[instruction(0x3D, ArithmeticTarget::L, prefixed = true)]
#[instruction(0x3E, ArithmeticTarget::HL, prefixed = true)]
#[instruction(0x3F, ArithmeticTarget::A, prefixed = true)]
fn handle_srl(cpu: &mut CPU, target: ArithmeticTarget) {
    let (value, pc_increment) = get_value_in_arithmetic_target(cpu, &target);
    let new_value = shift_right_logical(value, &mut cpu.registers.f);
